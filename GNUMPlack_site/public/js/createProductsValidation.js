    ...
    advantage.addEventListener('blur', function () {
        switch (true) {
            case !this.value.trim():
                ...
                break;
            case !(this.value.trim().length >= 10 && this.value.trim().length < 600):
                $('#advantageError').innerHTML = 'Las ventajas debe contener al menos 10 caracteres y no mas de 600 caracteres'
                this.classList.add('is-invalid')
                validate.advantage = false
                break;
            default:
    ...
    dimensions.addEventListener('blur', function () {
        switch (true) {
            case !this.value.trim():
                ...
                break;
            case !(this.value.trim().length >= 5 && this.value.trim().length < 45):
                $('#dimensionsError').innerHTML = 'Las dimensiones debe contener al menos 5 caracteres y no mas de 45 caracteres'
                this.classList.add('is-invalid')
                validate.dimensions = false
                break;
            default:
