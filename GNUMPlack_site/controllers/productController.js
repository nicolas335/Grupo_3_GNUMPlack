...
module.exports = {
    ...
    detail: (req, res) => {
        ...
        if (req.session.userLogin) {    // Si tiene la session busca las ordenes
        ...
        } else {    // Si no existe la session rederiza la vista con msg=0
            db.Products.findOne({ //busca el producto
                where: {
                    id: idParams
                },
                include: [{
